...
export function SupportPage() {
  ...
  return <MainLayout><main className="customer-support-page"><div className={accountMode ? 'account-shell' : 'customer-support-public-shell'}>{accountMode && <ProfileSidebar name={currentUser?.name} avatarImage={currentUser?.avatarImage} role={currentUser?.role} selectedKey="support" />}<section className={accountMode ? 'account-content customer-support-content' : 'customer-support-content'}>{content}</section></div></main></MainLayout>
}
