...
const permissionGroups: PermissionGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { value: 'virtual_try_on.read', label: 'Xem job phối đồ ảo' },
      { value: 'virtual_try_on.manage', label: 'Quản lý job phối đồ ảo' },
      { value: 'virtual_try_on.settings', label: 'Cấu hình phối đồ ảo' },
