...
export default function SupportTicketCreateScreen() {
  ...
  const submit = async () => {
    ...
    const validationError = validateSupportTicketDraft({ subject, body, category, orderId });
